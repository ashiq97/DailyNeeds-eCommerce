...
include 'includes/navigation.php';
 ...
 <div class="col-md-12">
  ...
  <button type="button" class="btn btn-lg btn-danger pull-right" onclick="location.href = 'admin_sales.php'" >Monthly Sales</button>
  <button type="button" class="btn btn-lg btn-info pull-right" onclick="location.href = 'admin_product_refill.php'" >Products To Be Refilled</button><div class="clearfix"></div><hr>
